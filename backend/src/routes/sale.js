...
router.post('/', auth, [
  ...
  body('sub_category').notEmpty().withMessage('子分类不能为空'),
  ...
  body('images').notEmpty().withMessage('图片不能为空'),
  ...
  try {
    ...
    const saleData = {
      ...
      images: Array.isArray(req.body.images) ? req.body.images.join(',') : req.body.images,
