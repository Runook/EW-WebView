          ...
          <div className="modal-body">
            ...
            <div className="form-row">
              <div className="form-group"><label>地点 *</label>
                <select name="location" required><option value="">请选择州</option>{US_STATES.map(l => <option key={l} value={l}>{l}</option>)}</select>
              </div>
            ...
            <div className="form-row">
              <div className="form-group"><label>设备状态</label>
                <select name="condition"><option value="">请选择（选填）</option>{conditions.map(c => <option key={c} value={c}>{c}</option>)}</select>
              </div>
